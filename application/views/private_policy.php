                ...
                <div class="col-md-12">
                    ...
                    <div class="text-contract">
                     ...
                     <div class="text-contract">
                        ...
                        name, username, password, e-mail, address, cryptocurrency address, mailing address.
                     </div>
                    <div class="text-contract">
                    ...
                    <div class="text-contract">
                        ...
                        Our Website may offer social sharing features, links to social media and other integrated tools. Your use of such features enables the sharing of information with your contacts or the public, depending on the settings you use with the entity that provides the social sharing feature or social media. Please visit the privacy policies of the entities that provide these features to obtain more information about the purpose and scope of data collection and the processing of such data by such entities.<br/>
                    </div>
                    <div class="text-contract">
